...
!cpu 65c02
;--------1--------2--------3--------4--------5--------6---
; Sweet16c2: A 65c02 Implmentation of a Virtual Machine
...
; is to run faster on a 65C02 system ... not to be smaller.
; This particular version is written within a 2 page
; (512byte) constraint, but uses a more memory intensive
; X-indexed jump and inlines several operations implemented
; with calls in Wozniak's original implementation.
